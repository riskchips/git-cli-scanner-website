    ...
    <Html center>
      {placeholderSrc ? (
        ...
        <div style={{
          ...
          <div style={{ marginTop: '8px', fontWeight: 'bold', color: '#111', fontFamily: '"Space Grotesk", sans-serif', fontSize: '14px', textAlign: 'center' }}>
  ...
  return (
    ...
    >
      ...
      <Canvas
        ...
        style={{ touchAction: 'pan-y pinch-zoom', outline: 'none', border: 'none' }}
      >
